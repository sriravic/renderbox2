...
namespace renderbox2
{
	...
	class IntegratorPath : public Integrator
	{
	public:

		IntegratorPath(const PathIntegratorParams& params, MemoryAllocator& allocator);
	...
	private:
		...
		PathIntegratorParams m_params;
	};

};				// !namespace renderbox2

#endif			// !INTEGRATOR_PATH_H
