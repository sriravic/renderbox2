...
bool jo_write_jpg(const char *filename, const void *data, int width, int height, int quality) {
	...
	static const float aasf[] = { 1.0 * 2.828427125f, 1.387039845f * 2.828427125f, 1.306562965f * 2.828427125f, 1.175875602f * 2.828427125f, 1.0f * 2.828427125f, 0.785694958f * 2.828427125f, 0.541196100f * 2.828427125f, 0.275899379f * 2.828427125f };
